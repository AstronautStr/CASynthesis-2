...
- **N2 (2026-09-16): реализовано Developer, ждёт ревью Researcher до прослушивания** —
  ...
  Проверки ТЗ 1–4: тесты (гейт 1j) + `demos/results/network_n2/report.md`. Пользователю
  каталог ещё не передан (по ТЗ сначала сверка Researcher).
