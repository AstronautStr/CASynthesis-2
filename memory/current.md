...
`python check.py` = 59 юнит-тестов + 39 + 9 + 6 + 6 + 6 + 15 тестов demo-стенда S1–S7 и демо S/N + 9 тестов N0 (гейт 1h) + 10 тестов N1 (гейт 1i) + golden-master аудио (байт-в-байт,
