...
- **N2 (2026-09-16): ТЗ готово, реализации ещё нет** —
  `memory/req-network-events-n2-2026-09-16.md`, по запросу пользователя.
  А — частотный Gutter; Б — события КА возбуждают новую затухающую сеть задержек.
  Три живых опыта с гипотезами для Notes; следующий шаг — Developer, затем ревью Researcher.
