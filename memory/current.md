...
- **Objects / Laplace (2026-09-17): реализовано, каталог собран, измерения сняты — ждёт технической
  сверки Researcher, затем слуховой приёмки пользователя** — ТЗ
  ...
  Прежний N4-каталог (закон Figure), его сцены и Notes сохранены; записи N4 сделаны v1 и открываются в
  своей версии. Ревью N4 Researcher: `memory/research/object-resonators-n4-review-2026-09-16.md`
  (опыты соответствуют гипотезам; слухового результата N4 пока нет).
