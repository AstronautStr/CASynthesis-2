...
- **Events / Birth position (2026-09-17): реализовано, каталог собран и запинен, ждёт сверки Researcher и слуха** — ТЗ
