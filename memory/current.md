...
`python check.py` = 59 юнит-тестов + 39 + 9 + 6 + 6 + 6 + 15 тестов demo-стенда S1–S7 и демо S/N + 9 тестов N0 (гейт 1h) + 9 тестов N1 (гейт 1i) + golden-master аудио (байт-в-байт,
...
- **N0/N1 (2026-09-15): ревью Researcher завершено** —
  ...
  (`memory/log/2026-09-15-network-n1.md`): движок `gutter_field`, сцена, `run_network_n1.bat`,
  9 тестов (гейт 1i), отчёт измерений `demos/results/network_n1/report.md`. **Ждёт:** ревью
