...
def test_registry_ui_hints_and_scene_validation():
    ...
    # Registry layout: 13 engines -> 5 rows (N1 channels + the two N2 engines).
    ...
    assert app.engine_rows == 5 and len(app.engine_btns) == 18     # + laplace_unified 2026-09-21; 4 per row since 2026-09-17
