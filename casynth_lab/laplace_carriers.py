"""Moved to casynth_engines.laplace_carriers (2026-09-21): the sound ENGINES are a
...
names: casynth_lab.laplace_carriers is casynth_engines.laplace_carriers, private names and all.
"""
import sys as _sys

from casynth_engines import laplace_carriers as _moved
