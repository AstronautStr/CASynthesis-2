"""Moved to casynth_engines.laplace_fm (2026-09-21): the sound ENGINES are a
...
names: casynth_lab.laplace_fm is casynth_engines.laplace_fm, private names and all.
"""
import sys as _sys

from casynth_engines import laplace_fm as _moved
